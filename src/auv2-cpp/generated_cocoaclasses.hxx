...
#define CLAP_WRAPPER_TIMER_CALLBACK timerCallback_wrapAsAUV2_cocoaUI##CLAP_WRAPPER_OBJC_SUFFIX
#define CLAP_WRAPPER_FILL_AUCV fillAUCV_wrapAsAUV2_cocoaUI##CLAP_WRAPPER_OBJC_SUFFIX
